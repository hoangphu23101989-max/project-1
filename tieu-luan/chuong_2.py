...
BLOCKS = [
    ...
    ("p", "Sự cháy và sự nung kim loại là những hiện tượng được con người quan sát từ rất sớm: vật cháy tỏa "
          "nhiệt và ánh sáng, gỗ cháy để lại tro nhẹ hơn, kim loại khi nung biến thành “vôi kim loại” "
          "(calx). Đầu thế kỷ XVIII, G.E. Stahl, phát triển ý tưởng của J.J. Becher, đã khái quát các hiện "
          "tượng này bằng thuyết phlogiston: vật cháy được là vật chứa phlogiston, sự cháy là quá trình giải "
          "phóng phlogiston, còn vôi kim loại là kim loại đã mất phlogiston. Thuyết này giải thích được một "
          "loạt hiện tượng có vẻ nhất quán, chẳng hạn việc khử vôi kim loại bằng than (được coi là giàu "
          "phlogiston) để thu lại kim loại [@brock1992]."),
    ("p", "Tuy vậy, thuyết phlogiston vấp phải một hiện tượng không phù hợp: vôi kim loại nặng hơn kim loại "
          "ban đầu. Năm 1774, J. Priestley điều chế được một loại “khí” duy trì sự cháy mạnh hơn không khí, "
          "và C.W. Scheele cũng thu được khí này một cách độc lập; song cả hai vẫn giải thích nó trong khuôn "
          "khổ của thuyết phlogiston. A.L. Lavoisier, bằng những thí nghiệm định lượng dùng cân trong hệ "
    ...
    ("p", "Năm 1869, D.I. Menđêlêép sắp xếp các nguyên tố theo chiều tăng của khối lượng nguyên tử và phát "
          "hiện sự lặp lại có quy luật của các tính chất. Ông để trống những vị trí chưa có nguyên tố tương "
          "ứng và dự báo tính chất của chúng; các nguyên tố gali (1875), scanđi (1879) và gecmani (1886) "
          "được phát hiện sau đó với tính chất phù hợp với dự báo [@brock1992]. Đồng thời, Menđêlêép đã đặt "
          "telu trước iot dù khối lượng nguyên tử của telu lớn hơn, vì ông ưu tiên sự tương đồng về tính "
          "chất hơn trật tự khối lượng."),
    ("p", "Những trường hợp đảo ngược như telu – iot, coban – niken, agon – kali cho thấy khối lượng nguyên "
          "tử có liên hệ với bản chất của tính tuần hoàn nhưng không phải là bản chất đó. Năm 1913, H.G.J. "
          "Moseley đo tần số tia X đặc trưng của các nguyên tố và chỉ ra rằng căn bậc hai của tần số biến "
          "thiên tuyến tính theo một số nguyên tăng dần đều theo vị trí trong bảng tuần hoàn, tức là số hiệu nguyên tử, đại "
    ...
    ("p", "Các hiện tượng gắn với acid được biết từ lâu: vị chua, làm đổi màu chất chỉ thị, tác dụng với "
          "kim loại giải phóng khí hydro, trung hòa base. Cuối thế kỷ XIX, thuyết điện ly của S. Arrhenius "
          "định nghĩa acid là chất phân ly trong nước tạo ion H^{+} [@brock1992]. Năm 1923, J.N. Brønsted và "
    ...
    ("p", "Trong thập niên 1820, người ta phát hiện rằng bạc cyanat và bạc fulminat có cùng thành phần "
          "nguyên tố nhưng tính chất khác hẳn nhau; J.J. Berzelius gọi hiện tượng này là đồng phân. Sau đó, "
          "thuyết cấu tạo hóa học khẳng định tính chất của chất phụ thuộc không chỉ vào thành phần mà vào "
          "trật tự liên kết giữa các nguyên tử. L. Pasteur (1848) tách được hai dạng tinh thể đối xứng gương "
          "của muối tartrat có tính quang hoạt ngược nhau, và J.H. van 't Hoff cùng J.A. Le Bel (1874) giải "
    ...
    ("p", "Năm 1913, L. Michaelis và M.L. Menten nghiên cứu động học của enzyme invertase và chỉ ra rằng tốc "
          "độ phản ứng tỉ lệ với nồng độ của phức hợp enzyme – cơ chất, một thực thể mà lúc đó chưa thể quan "
          "sát trực tiếp [@johnson2011]. Từ những hiện tượng động học (sự phụ thuộc của tốc độ vào nồng độ cơ "
          "chất), họ đã suy ra một bản chất (sự hình thành phức hợp trung gian) và biểu đạt nó bằng các hằng "
          "số định lượng. Các phương pháp động học sau đó cho phép phân biệt các kiểu ức chế enzyme và xác "
          "định hằng số ức chế [@copeland2013]. Năm 1958, D.E. Koshland đề xuất giả thuyết “khớp cảm ứng”, "
    ...
    ("p", "Năm trường hợp trên cho phép rút ra năm bài học nhận thức luận có ý nghĩa đối với nghiên cứu hóa "
          "học hiện nay."),
    ("p", "*Một là*, hiện tượng là điểm xuất phát không thể thay thế: mọi bước tiến tới bản chất đều dựa "
          "trên những hiện tượng mới hoặc được đo đạc chính xác hơn, như khối lượng trong thí nghiệm của "
          "Lavoisier hay tần số tia X trong thí nghiệm của Moseley."),
    ...
    ("p", "*Bốn là*, bản chất có nhiều cấp độ; các cấp độ sau bao hàm các cấp độ trước theo kiểu phủ định "
          "biện chứng. Tri thức ở mỗi cấp độ là chân lý tương đối, và việc dừng lại ở một cấp độ chưa đủ sâu "
          "có thể dẫn đến hành động sai lầm, như trường hợp thalidomide."),
    ("p", "*Năm là*, thực tiễn, bao gồm dự báo được kiểm chứng (các nguyên tố của Menđêlêép), tổng hợp có "
          "chủ đích (alizarin) và xác định cấu trúc (lysozyme), là tiêu chuẩn cuối cùng để xác nhận rằng nhận "
          "thức đã đạt tới bản chất ở một cấp độ nhất định."),

    ("sub", "Tiểu kết Chương 2"),
    ("p", "Lịch sử hóa học xác nhận các luận điểm của phép biện chứng duy vật về quan hệ giữa bản chất và "
          "hiện tượng: nhận thức đi từ hiện tượng đến bản chất, từ bản chất cấp thấp đến bản chất cấp cao; "
          "giả tượng được vượt qua bằng kiểm soát điều kiện; mâu thuẫn giữa lý thuyết và dữ kiện là động lực "
          "phát triển; thực tiễn là tiêu chuẩn của chân lý. Những bài học này là cơ sở để phân tích thực trạng "
          "đánh giá hoạt tính sinh học của hợp chất thiên nhiên ở Chương 3."),
]
